...
module.exports = {
    ...
    /**
     * This method will loop over all matches of a single regex. This is not a common part of JS yet, so this is
     * a good way of doing it according to https://github.com/airbnb/javascript/issues/1439#issuecomment-306297399
     * and doesn't get us in trouble with linting rules.
     *
     * @param {String} str
     * @param {RegExp} regex
     *
