...
module.exports = {
    ...
    /**
     * Returns true if the login is an email address or a valid phone number
     *
     * @param {String} text
     * @return {bool}
     */
    isValidEmailOrPhone(text) {
        return module.exports.isValidEmail(text) || module.exports.isValidPhone(text);
    }
};
