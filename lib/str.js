...
module.exports = {
     ...
     */
    areValidEmails: function (string) {
        var emails = string.split(',');
        return !string || _.all(emails, function (email) {
            return module.exports.isValidEmail(email.trim());
        });
    },
     ...
     * @returns {string|null}
     */
    sanitizePhoneNumber: function (string) {
