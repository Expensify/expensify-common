...
const Str = {
    ...
    /**
     * We validate mentions by checking if it's first character is valid for mention
     * For example, *@username@expensify.com* is a valid mention because we allow bold styling for it.
     * A valid mention starts with a space, *, _, #, ', ", or @ (means with no preceding characters).
     *
