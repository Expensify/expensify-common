...
module.exports = {
    ...
    /**
     * Checks that the string is a list of coma separated valid logins.
     *
    ...
    areValidLogins(str) {
        ...
        const logins = string.split(',');
        let result = true;
        for (let i = 0; i < logins.length; i += 1) {
            if (!module.exports.isValidEmail(logins[i].trim()) && !module.exports.isValidPhone(logins[i].trim())) {
                result = false;
            }
        }
        return result;
