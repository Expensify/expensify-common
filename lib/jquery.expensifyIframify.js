...
module.exports = {
    ...
    load($, _) {
        ...
        const allowedCommunications = {
            'https://www.expensify.com': ['https://secure.expensify.com'],
            'https://secure.expensify.com': ['https://www.expensify.com', 'https://salesfoce.expensify.com'],
            'https://staging.expensify.com': ['https://staging-secure.expensify.com'],
            'https://staging-secure.expensify.com': ['*'],
            'https://staging2.expensify.com': ['https://staging-secure.expensify.com'],
            'https://www.expensify.com.dev': ['https://secure.expensify.com.dev'],
            'https://secure.expensify.com.dev': ['https://www.expensify.com.dev'],
        };
        ...
        function postMessage(name, data, postToIframe) {
            ...
            let isCommunicationAllowed = allowedCommunications[settings.origin];
            ...
            if (!postToIframe && window.parent !== window) {
                newOrigin = window.parent.location.protocol + '//' + window.parent.location.hostname;
                log('posting message to parent', newOrigin, msg);
                window.parent.postMessage(msg, newOrigin);
            }

            // Sending message from the parent to the iFrame
            if (postToIframe && self[0].contentWindow) {
                newOrigin = self[0].contentWindow.location.protocol + '//' + self[0].contentWindow.location.hostname;
                log('posting message to iframe', newOrigin, msg);
        ...
        function handleWindowMessage(event) {
            ...
            if (allowedCommunications[event.origin].indexOf('*') === -1 &&
