    ...
    modifyTextForUrlLinks(regex, textToCheck, replacement) {
        ...
        while (match !== null) {
            ...
            if (abort) {
                ...
                // If the link text `match[1]` is exactly a url, then we will skip translating ['bold', 'strikethrough', 'italic']
                // rules for it to keep special characters, like ['_', '*', '~'], in the original url.
