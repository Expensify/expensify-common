    ...
    constructor() {
        ...
        this.rules = [
             ...
             */
            {
                ...
                replacement: (match, g1, g2) => `<img src="${Str.sanitizeURL(g2)}"${g1 ? ` alt="${this.escapeMarkdownEntities(g1)}"` : ''} />`,
                rawInputReplacement: (match, g1, g2) => `<img src="${Str.sanitizeURL(g2)}"${g1 ? ` alt="${this.escapeMarkdownEntities(g1)}"` : ''} data-raw-href="${g2}" data-link-variant="labeled" />`
            },
