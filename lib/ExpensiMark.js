    ...
    constructor() {
        ...
        this.rules = [
            ...
            */
             ...
             *
             * Note: currently we are only allowing mentions in a format of @+19728974297@expensify.sms and @username@expensify.com
             * inorder to match mentions in a format of @username we should update the regex to: (?!@here)+((&#x60;|<code>|<pre>)\s*?)?[`.]?@+[\w+]*
             */
            {
                name: 'userMentions',
                ...
                replacement: (match) => {
                    ...
                    return isMatchValid ? `<mention-user>${match}</mention-user>` : match;
                }
            },
