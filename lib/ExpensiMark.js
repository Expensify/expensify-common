...
export default class ExpensiMark {
    ...
    /**
     * replace [block] with new line if :
     * 1- we have text before the [block].
     * 2- the text not end with new line .
     * 3- the text not the quote mark "> " .
    ...
    replaceBlockWithNewLine(htmlString) {
        ...
        splitText.forEach((text, index) => {
            ...
            // map all block to new line if it not end with newline or quote or it's last block .
