...
export default class ExpensiMark {
    ...
    truncateMarkdown(text, limit, ellipsis) {
        ...
        const truncatedTextWithoutOrphanedWord = truncatedText.slice(0, lastSpaceIndex);

        // Convert the truncated text back to Markdown
        const truncatedHtml = this.replace(truncatedTextWithoutOrphanedWord);
