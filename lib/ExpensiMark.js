...
export default class ExpensiMark {
        ...
        this.htmlToMarkdownRules = [
            ...
            },
            {
                ...
                replacement: (match, g1, g2) => {
                    ...
                    resultString = resultString.map(prependGreaterSign).join('\n');
    ...
    escape(text) {
        ...
        return text.replace(matchHtmlRegExp, (match) => {
            switch (match) {
                case '&':
                    return '&amp;';
                case '<':
    ...
    replace(text, {filterRules = [], shouldEscapeText = true, shouldKeepRawInput = false, disabledRules = []} = {}) {
        ...
        let replacedText = shouldEscapeText ? this.escape(text) : text;
        ...
        try {
            ...
            return shouldEscapeText ? this.escape(text) : text;
        }
    ...
    escapeAttributeContent(content) {
        ...
        return this.escape(originalContent);
    }
}
