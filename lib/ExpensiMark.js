...
export default class ExpensiMark {
    ...
    constructor() {
        ...
        this.rules = [
            ...
            /**
             * Converts markdown style images and videos to image/video tags e.g. ![Expensify](https://www.expensify.com/attachment.png)
             ...
             */
            {
                ...
                rawInputReplacement: (match, g1, g2, ...args) => {
                    ...
                    return `<img src="${Str.sanitizeURL(g2)}"${g1 ? ` alt="${this.escapeAttributeContent(g1)}"` : ''} data-raw-href="${g2}" data-link-variant="${typeof (g1) === 'string' ? 'labeled' : 'auto'}" />`
                }
            },
...

            {
                ...
                replacement: (match, g1, g2, g3, g4, ...args) => {
                    ...
                    if(g3 && extras && extras.cacheVideoAttributes && typeof extras.cacheVideoAttributes === 'function') {
                        extras.cacheVideoAttributes(g2, g3); // cacheVideoAttributes(source, attributes)
                    }
                    if (g4) {
                        return `![${g4}](${g2})`;
                    }
