...
module.exports = React.createClass({
    ...
    setValue(val) {
        ...
        console.log('setValue() setting original value to ', this.originalValue, val)
        this.setState({
            currentValue: val,
            currentText,
            options: newOptions
    ...
    handleKeyDown(e) {
        ...
        case KeyboardShortcutManager.MAPPINGS.KEY_ENTER: {
            ...
            const currentValue = this.state.options[this.state.focusedIndex].value;
            const currentText = this.state.options[this.state.focusedIndex].text;
            ...
            this.originalValue = this.state.options[this.state.focusedIndex].value;
            this.stopEvent(e);
            break;
        }
