...
module.exports = React.createClass({
    ...
    getInitialState(noDefaultValue, newOptions) {
        ...
        let defaultSelectedOption = _(this.options).findWhere({value: this.originalValue || this.props.defaultValue});

        // if no default was found and originalText was present then we can use originalText values
        if (!defaultSelectedOption && this.originalText) {
            defaultSelectedOption = [];
            defaultSelectedOption.text = this.originalText;
        }
    ...
    handleClickAway(e) {
        ...
        this.reset(true);
        this.props.onChange(this.originalValue || this.props.defaultValue, this.originalText);
    },
