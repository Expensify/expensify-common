...
module.exports = window.CreateClass({
    ...
    /**
     * An action that will set the disabled state of this widget
     *
     * @param {Object} value
     * @param {Function} callback
     * @param {jQuery.Element} $this
     */
    setDisabled(value, callback, $this) {
        let $option;
        if ($this.data('expensifyComboify_combobox')) {
            $this.data('expensifyComboify_combobox').setDisabled(value);
