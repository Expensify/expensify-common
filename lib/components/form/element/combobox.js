...
module.exports = React.createClass({
    ...
    /**
     * Sets the current value. If entry is out of policy we can set it to a manual entry by defining outOfPolicy as true
     *
     * @param {String} val
     * @param {Boolean} outOfPolicy
     * @param {String} categoryText
     */
    setValue(val, outOfPolicy, categoryText) {
        let currentText = '';
        outOfPolicy = outOfPolicy || false;
