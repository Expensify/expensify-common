...
module.exports = window.CreateClass({
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (!_.isUndefined(nextProps.options)) {
            ...
            } else if (!_.isEqual(nextProps.options, this.props.options)) {
                this.reset(false, nextProps.options);
            }
        }
    },
    ...
    reset(noDefaultValue, newOptions) {
        ...
        const state = this.getInitialState(noDefaultValue, this.options);
    ...
    handleKeyDown(e) {
        ...
        case 13: {
            ...
            // If allowAnyValue is true and enter has been pressed then let's set the currentValue and text to the manual entry
    ...
    performSearch(e) {
        ...
        if (this.props.allowAnyValue || !options.length) {
            options.push({
