...
class Combobox extends React.Component {
    ...
    componentDidUpdate(_prevProps, prevState) {
        ...
        if (dropdown) {
            // Set scroll position to the last known location
            dropdown.scrollTop = prevState.scrollPosition;
        }
    }
    ...
    getStartState(noDefaultValue, newOptions, newAlreadySelectedOptions) {
        ...
        return {
            ...
            scrollPosition: this.state ? this.state.scrollPosition : 0
        };
    }
    ...
    handleClick(selectedValue) {
        ...
        const scrollPosition = ReactDOM.findDOMNode(this.DropDown).scrollTop;
                ...
                <div className={cn(inputGroupBtnClasses)}>
                    ...
                    {this.state.isDropdownOpen && (
                        <DropDown
                            ...
                            bs4={this.props.bs4}
                            extraClasses={{'expensify-dropdown': true, show: this.props.bs4 && this.state.isDropdownOpen}}
