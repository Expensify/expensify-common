...
module.exports = React.createClass({
    propTypes: {
        ...
        // A validation callback which will be passed the current value and will return either
        // true or false
        isValid: React.PropTypes.func,

        // A callback that is fired when the value of the selector has changed
        // If isValid was specified, then onChange will only fire if the value is valid
     ...
     * @param {Object[]} [newOptions] when resetting this components, we can specifiy new options to use
     *
     * @returns {Object}
     */
