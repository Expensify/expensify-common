...
class Combobox extends React.Component {
    ...
    getStartState(noDefaultValue, newOptions, newAlreadySelectedOptions) {
        ...
        // We use regex here to take out "@expensify.sms" in case currentValue is a phone number
        let defaultSelectedOption = _(this.options).find(o => o.value.replace(new RegExp(/@expensify.sms/g), '') === currentValue && !o.isFake);
