...
module.exports = React.createClass({
    ...
    /**
     * Hard sets the current value to want we want. Currently used for values that are out of policy and hence
     * unavailable in this.state.options
     *
     * @param {String} currentValue
     * @param {String} currentText
     */
    setText(currentValue, currentText) {
