        ...
        for (const matchRegex of matchRegexes) {
            if (matches.size < this.props.maxSearchResults) {
                for (const option of searchOptions) {
                    ...
                    const isMatch = matchRegex.test(option.text.toString().replaceAll('&nbsp;', ''));
        ...
        return (
            ...
            >
                <input
                    ...
                    value={this.props.propertyToDisplay === 'value' ? Utils.unescapeText(this.state.currentValue) : Utils.unescapeText(this.state.currentText.replaceAll('&nbsp;', ''))}
