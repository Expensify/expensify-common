...
function DropDownItem(props) {
    ...
    return (
        <li className={React.classNames(classes.li)} data-value={props.value}>
            <a className={React.classNames(classes.a)} onClick={clickHandler} tabIndex="-1" data-toggle="tooltip" data-container="body" data-delay='{"show":1000, "hide":100}' title={_.isString(props.children) ? props.children : Str.htmlDecode(props.text)}>
