...
module.exports = {
    REG_EXP: {
        ...
        /**
         * Regular expression matching an E.164 phone number starting with a '+'
         */
        SMS_E164_PLUS: /^\+?[1-9]\d{1,14}$/
    },

    /**
     * Domain used for SMS / phone-based accounts
     *
     * @type String
     */
    SMS_DOMAIN: '@expensify.sms'
};
