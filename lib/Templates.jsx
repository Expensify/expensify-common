...
class TemplatesConstructor {
    ...
    getTemplate(templatePath) {
        let template = this.templateStore;
     ...
     */
    getTemplateNamespace(wantedNamespace) {
        let namespace = this.templateStore;
        let currentArgument;
    ...
    init() {
        ...
        $('.js_template').each((_, $el) => {
            ...
            const namespace = this.getTemplateNamespace(namespaceElements);
    ...
    register(wantedNamespace, templateData) {
        const namespace = this.getTemplateNamespace(wantedNamespace);
    ...
    unregister(nameSpace) {
        delete this.templateStore[nameSpace];
    }
...
const Templates = new TemplatesConstructor();
