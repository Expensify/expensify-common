...
test('Test markdown replacement for emails and email links containing bold/strikethrough/italic', () => {
    ...
    testInput = 'Jaj@.cdjd';
    expect(parser.replace(testInput)).toBe('<a href="mailto:Jaj@.cdjd">Jaj@.cdjd</a>');

    // testInput = '__sadjkfasdjasdflaajdfghadkf@kasdfljasdkfajlsdf-sad-fasdf-a-sdf-asd.io.com.ee';
    // expect(parser.replace(testInput)).toBe(`<a href="mailto:${testInput}">${testInput}</a>`);
