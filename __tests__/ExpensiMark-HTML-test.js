...
test('Test code fencing with spaces and new lines', () => {
    ...
    expect(parser.replace(codeFenceExample, {shouldEscapeText: false})).toBe(
        "<pre>const&#32;javaScript&#32;=&#32;'javaScript'<br />&#32;&#32;&#32;&#32;const&#32;php&#32;=&#32;'php'<br /></pre>",
    );
...
test('Test a url ending with a question mark autolinks correctly', () => {
    const testCases = [
        ...
        {
            testString: 'https://github.com/Expensify/ReactNativeChat/pull/645?test',
            resultString:
                '<a href="https://github.com/Expensify/ReactNativeChat/pull/645?test" target="_blank" rel="noreferrer noopener">https://github.com/Expensify/ReactNativeChat/pull/645?test</a>',
        },
    ];
...
test('Test quotes markdown replacement with text matching inside and outside codefence without spaces', () => {
    ...
    const resultString =
        'The next line should be quoted<br /><blockquote>Hello,I’mtext</blockquote><pre>The&#32;next&#32;line&#32;should&#32;not&#32;be&#32;quoted<br />&gt;Hello,I’mtext<br />since&#32;its&#32;inside&#32;a&#32;codefence<br /></pre>';
...
test('Test quotes markdown replacement with text matching inside and outside codefence at the same line', () => {
    ...
    const resultString =
        'The next line should be quoted<br /><blockquote>Hello,I’mtext</blockquote>The next line should not be quoted<br /><pre>&gt;Hello,I’mtext<br /></pre>since its inside a codefence';
